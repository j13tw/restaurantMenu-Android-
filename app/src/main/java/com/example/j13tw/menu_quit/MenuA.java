...
public class MenuA extends AppCompatActivity {
    ...
    public void errorA(){
        AlertDialog.Builder chooseCheck = new AlertDialog.Builder(MenuA.this);
            ...
            public void onClick(View v) {
                ...
                if(TypeA.isChecked() && !("".equals(countA.getText().toString())) && (errorCheck == 0)){
                    if(Integer.parseInt(countA.getText().toString()) <= 0){
                        ...
                        cash += Integer.parseInt(countA.getText().toString())*120;
                        kal += Integer.parseInt(countA.getText().toString())*800;
                        mealCount++;
                ...
                if(TypeB.isChecked() && !("".equals(countB.getText().toString())) && errorCheck == 0){
                    if(Integer.parseInt(countB.getText().toString()) <= 0){
                        ...
                        cash += Integer.parseInt(countB.getText().toString())*130;
                        kal += Integer.parseInt(countB.getText().toString())*500;
                        mealCount++;
                ...
                if(TypeC.isChecked() && !("".equals(countC.getText().toString())) && errorCheck == 0){
                    if(Integer.parseInt(countC.getText().toString()) <= 0){
                        ...
                        cash += Integer.parseInt(countC.getText().toString())*250;
                        kal += Integer.parseInt(countC.getText().toString())*900;
                        mealCount++;
                ...
                if(TypeE.isChecked() && !("".equals(countE.getText().toString())) && errorCheck == 0){
                    if(Integer.parseInt(countE.getText().toString()) <= 0){
                        ...
                        cash += Integer.parseInt(countE.getText().toString())*100;
                        kal += Integer.parseInt(countE.getText().toString())*300;
                        mealCount++;
                ...
                if(TypeF.isChecked() && !("".equals(countF.getText().toString())) && errorCheck == 0){
                    if(Integer.parseInt(countF.getText().toString()) <= 0){
                        ...
                        cash += Integer.parseInt(countF.getText().toString())*180;
                        kal += Integer.parseInt(countF.getText().toString())*350;
                        mealCount++;
                ...
                if(errorCheck == 0 && mealCount != 0){
                    AlertDialog.Builder sendCheck = new AlertDialog.Builder(MenuA.this);
                    ...
                    sendCheck.setNegativeButton("確認", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ShowCash.setClass(MenuA.this, ShowCash.class);
                            ...
                            show.putString("TypeA", "客家小炒   $120");
                            show.putString("TypeB", "辣炒箭筍   $130");
                            show.putString("TypeC", "鐵板豆腐   $250");
                            show.putString("TypeD", "五更腸旺   $200");
                            show.putString("TypeE", "現炒時蔬   $100");
                            show.putString("TypeF", "竹筍肉絲   $180");
